...
<a href="logout.php"><span class="glyphicon glyphicon-log-out"></span> Logout</a>
  ...
  xhttp.open("GET", "ins.php?trn="+trn, true);
  xhttp.send();
}
  ...
  <tbody>
    ...
    <tr>
      <th>Select Train Name:</th>
      <td><select onchange="insSt();" id="trn" name="trn">
      ...
      <td><input title="To manage Items in future" type="Password" name="pass"></td>
            ...
            <tr>
      <th></th>
      <td><input class="btn btn-success" type="Submit" name="trssub"></td>
    </tr>
  </tbody>
</form>
</table>
