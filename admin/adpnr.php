...
<a href="logout.php"><span class="glyphicon glyphicon-log-out"></span> Logout</a>
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
     document.getElementById("pnr").innerHTML = this.responseText;
    }
  };
  xhttp.open("GET", "ins.php?trnst="+trn, true);
  xhttp.send();
}
  ...
  <tbody>
    ...
    <tr>
      <th>Select Train:</th>
      <td><select onchange="insStop();" id="trn" name="trn" required>
        <option  value="selected" disabled selected>Select Train</option>
        <?php
        $c=$mysqli->query("select * from train");
    ...
    <div id="pnr">
      ...
      <td><input title="To manage Items in future" type="Password" name="pass"></td>
            ...
            <tr>
      <th></th>
      <td><input class="btn btn-success" type="Submit" name="pnrsub"></td>
    </tr>
  </tbody>
</form>
</table>
