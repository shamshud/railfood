...
<html lang="en">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            ...
            if(isset($_GET['ins'])){
              if($_GET['ins']=='s'){
                echo '<span><strong>Ordered Successfully.! Click on orders to know your order status</strong></span>';
              }
            }
            ?>
          </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <div id="validate"><a onclick="showStop();" class="btn btn-info">check</a></div></td>
    </tr>
     </tbody>
    </table>
        ...
        <div class="row">
          <div class="col-lg-6 h-100 text-center text-lg-left my-auto">
            <ul class="list-inline mb-2">
             ...
             <a href="admin/index.php" class="btn btn-info">Goto Admin Page</a>
